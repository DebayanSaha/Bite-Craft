    ...
    <div className="relative bg-transparent w-full min-h-screen overflow-hidden">
      ...
      <div className='relative w-full h-30 p-3'>
        ...
        <div className='absolute right-0 top-5 md:w-70 w-45 font-[font2] text-[#E8E4D7] flex md:gap-10 gap-5'>
          <h1 onClick={()=>nav('/partnerwithus')} className='cursor-pointer font-[font5] md:text-xl md:mt-4 mt-2'>Partner with us</h1>
          <button onClick={()=>nav('/user/login')} className='cursor-pointer bg-yellow-500 font-[font5] font-semibold md:px-6 px-4 md:py-3 py-2 md:text-2xl text-zinc-800 rounded-2xl shadow-xl shadow-orange-900/30'>Sign in</button>
        </div>
      </div>
